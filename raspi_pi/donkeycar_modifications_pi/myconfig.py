...
# ── Camera ───────────────────────────────────────────────────────────
CAMERA_TYPE = "MOCK"   # Use the Oak-D Lite via DepthAI
IMAGE_W = 160
IMAGE_H = 120
...
VESC_MAX_SPEED_PERCENT = 0.5     # Start at 50% of max speed; increase gradually as the model improves
...
# ── Joystick ─────────────────────────────────────────────────────────
USE_JOYSTICK_AS_DEFAULT = False     # Removes the need to pass --js on every launch
JOYSTICK_MAX_THROTTLE = 0.25        # Limit top speed during data collection for safety
